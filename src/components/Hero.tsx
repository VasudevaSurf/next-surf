    ...
    return (
      <section className="relative w-full overflow-hidden bg-white">
        <div className="grid grid-cols-1 lg:grid-cols-2 min-h-[520px] items-stretch">
          <div className="order-2 lg:order-1 flex flex-col justify-center px-6 md:px-12 py-12 lg:py-24 max-w-[640px] ml-auto w-full">
            {badge && (
              <motion.div
          ...
          <div className="order-1 lg:order-2 relative min-h-[360px] lg:min-h-full overflow-hidden">
            <img
              src={image}
              alt={title}
